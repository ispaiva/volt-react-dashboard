...
const trafficShares = [
    ...
    { id: 2, label: "Mobile Web", value: 20, color: "primary", icon: faMobileAlt },
    { id: 3, label: "Tablet Web", value: 20, color: "tertiary", icon: faTabletAlt }
];

const totalOrders = [
    { id: 1, label: "July", value: [1, 5, 2, 5, 4, 3], color: "primary" },
    { id: 2, label: "August", value: [5, 3, 4, 8, 1, 2], color: "secondary" }
];
